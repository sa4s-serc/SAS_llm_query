...
const Bassam = () => {
  ...
  const [currentIndex, setCurrentIndex] = useState(66);
  ...
  const handlePrevious = () => {
    if (currentIndex > 66) setCurrentIndex(currentIndex - 1);
  };

  const handleNext = () => {
    if (currentIndex < 99) setCurrentIndex(currentIndex + 1);
  };
