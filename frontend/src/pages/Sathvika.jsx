...
const Sathvika = () => {
  ...
  const [currentIndex, setCurrentIndex] = useState(33);
  ...
  const handlePrevious = () => {
    if (currentIndex > 33) setCurrentIndex(currentIndex - 1);
  };

  const handleNext = () => {
    if (currentIndex < 65) setCurrentIndex(currentIndex + 1);
  };
