...
logger = setup_logger("SensorWaterService")
...
class SensorWaterService(MicroserviceBase):
    def __init__(self):
        super().__init__("sensor_water_service")
        self.update_service_info(
            description="Handles water sensor data and notifications",
    ...
    async def _get_data(self, id: str):
        try:
            data = self._fetch_from_mongodb("water_sensor_db", "watersensordata", id)
            if data:
